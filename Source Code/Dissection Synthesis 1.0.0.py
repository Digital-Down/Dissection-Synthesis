...
class DissectionSynthesisGUI:
    def __init__(self, master):
        ...
        self.master = master
        master.title("Digital Down's Dissection Synthesis 1.0.0")
...
if __name__ == "__main__":
    ...
    root.mainloop()
#Exe string in command prompt: pyinstaller --onefile --windowed --hidden-import=Audio.DissectionSynthesis --hidden-import=Audio.AudioSampleValues --add-data "Background.png;." "Dissection Synthesis 1.0.0.py"